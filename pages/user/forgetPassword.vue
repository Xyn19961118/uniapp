		...
		<view class="items">
			...
			<view class="item">
				<view class="item-left">
					...
					<input class="input" type="password" :value="firstPassword" @blur="veFirstPassword" placeholder="请输入您的新密码"
					 placeholder-class="place" />
				</view>
			</view>
			<view class="item">
				<view class="item-left">
					<image class="icon" src="http://m.prizemart.cn/mobile/images/login-password.png"></image>
					<input class="input" type="password" :value="secondPassword" @blur="veSecondPassword" placeholder="请再次输入您的新密码"
					 placeholder-class="place" />
				</view>
			</view>
			<!-- <view class="item">
			...
			<button class="btn registered" @tap="goRegist" type="button">提交</button>
